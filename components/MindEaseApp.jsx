...
export default function MindEaseApp() {
  ...
  // ── Auto-detect region once on mount ────────────────────────────────────────
  useEffect(() => {
    if (langInfo) { setDetecting(false); return; } // already persisted
  ...
  return (
    <>
      ...
      {/* ── Shared button & responsive styles ── */}
      <style>{`
